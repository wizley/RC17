...
#define LINESENSOR_0_SIZE             24//how many line sensor module i use per line
#endif
...
#if !defined(CH_TIME_QUANTUM) || defined(__DOXYGEN__)
#define USE_AIR_0            TRUE
#define AIR_0_SIZE             16
#endif
