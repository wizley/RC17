...
//#if USE_MOTOR_0
//    {ID_M1_VMODE, (udc_tx_data_t)&M[0].SetPoint, 2, (udc_rx_data_t)&M[0].Feedback, 2, &motor_setAlive, &M[0]},
//#endif
//#if USE_MOTOR_1
//    {ID_M1_VMODE, (udc_tx_data_t)&M[1].SetPoint, 2, (udc_rx_data_t)&M[1].Feedback, 2, &motor_setAlive, &M[1]},
//#endif
...
//#endif
#if USE_AIR_0
    {110, (udc_rx_data_t) &AirBoard.states , 2, NULL, 0, NULL, NULL}, //your struct
#endif
