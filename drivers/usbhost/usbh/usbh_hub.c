...
#if !DRIVER_USE_USBH
#error "USBHHUB needs DRIVER_USE_USBH"
#endif
...
USBHHubDriver USBHHUBD[DRIVER_USBHHUB_MAX_INSTANCES];
usbh_port_t USBHPorts[DRIVER_USBHHUB_MAX_PORTS];
...
alloc_ok:
	...
	for (i = 0; (ports > 0) && (i < DRIVER_USBHHUB_MAX_PORTS); i++) {
