...
#if DRIVER_USE_USBH && DRIVER_USBH_USE_FTDI
...
/*===========================================================================*/
extern USBHFTDIDriver USBHFTDID[DRIVER_USBHFTDI_MAX_INSTANCES];
extern USBHFTDIPortDriver FTDIPD[DRIVER_USBHFTDI_MAX_PORTS];
