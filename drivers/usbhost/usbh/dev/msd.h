...
#if DRIVER_USE_USBH && DRIVER_USBH_USE_MSD
...
extern USBHMassStorageLUNDriver MSBLKD[DRIVER_USBHMSD_MAX_LUNS];
extern USBHMassStorageDriver USBHMSD[DRIVER_USBHMSD_MAX_INSTANCES];
